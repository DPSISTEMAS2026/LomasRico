...
export async function changeUserPassword(token: string, data: any) {
...
export async function createSale(items: any[], options: { channel?: string, status?: string, userId?: string, shippingData?: any } = {}) {
    const payload = {
